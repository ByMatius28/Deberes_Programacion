...
let CreaturesController = class CreaturesController {
    ...
    findAll() {
        return this.creaturesService.findAllcreatures();
    }
    findAllnoExtinct() {
        return this.creaturesService.findAllnoExtinct();
    }
    findAllExtincts() {
...
__decorate([
    (0, common_1.Get)('creatures'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], CreaturesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)('noExtincts'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], CreaturesController.prototype, "findAllnoExtinct", null);
__decorate([
    (0, common_1.Get)('extincts'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], CreaturesController.prototype, "findAllExtincts", null);
__decorate([
    (0, common_1.Get)(':id'),
