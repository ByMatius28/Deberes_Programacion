La función `hey` toma un mensaje como entrada y devuelve una respuesta basada en el contenido del mensaje. Aquí hay una descripción de cada función utilizada en el código:
